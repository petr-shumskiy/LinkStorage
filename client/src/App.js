    ...
    linkData: [
      {
        ...
        linkText:
          'Международная сеть Cofix открыла уже более 180 кофеен! Ароматный свежесваренный кофе, лимонады, апельсиновый и морковный фреш, выпечка, сэндвичи, салаты, суп, пицца и десерты – все по фиксированной цене.'
      },
      {
